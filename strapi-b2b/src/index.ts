...
function loadSampleData(filename: string): any[] | null {
  try {
...
// Import categories
async function importCategories(strapi: any): Promise<any[]> {
...
// Import suppliers
async function importSuppliers(strapi: any): Promise<any[]> {
...
// Import products
async function importProducts(strapi: any, categories: any[], suppliers: any[]): Promise<any[]> {
